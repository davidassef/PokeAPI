...
echo "      - Nome: pokeapiapp-client-server"
...
echo "   curl https://pokeapiapp-client-server.onrender.com/api/client/health"
echo "   curl https://pokeapiapp-client-server.onrender.com/api/client/sync-data"
